...
### Cautionary
This game uses the original dungeon generation algorithm from The Binding of Isaac and, as such, may have infinite load times. This is extremely rare but it can happen, usually causing a stack overflow error. If the game does not start within 5 seconds just run the sketch again; it's not worth the wait.
